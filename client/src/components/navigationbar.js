           ...
           <Navbar className="navigate-bar" expand="lg">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              ...
              <Nav.Link href="/" className="text">Home</Nav.Link>
                <Nav.Link href="/createartist" className="text">Create Artist</Nav.Link>
                <NavDropdown title="About" id="basic-nav-dropdown" className="text">
                ...
                <NavDropdown title="View More" id="basic-nav-dropdown" className="text">
